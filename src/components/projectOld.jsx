...
function Projects() {
  return (
    <div className="relative z-10 bg-neutral-950 py-32 md:py-56">
      <div className="mx-auto max-w-screen-lg text-white md:px-0">
        <div className="flex flex-col lg:flex-row px-8 md:px-20">
          <h1 className="text-sm text-neutral-500 uppercase">Projects / </h1>
        </div>
          ...
          <div className="max-w-screen-lg flex overflow-x-auto space-x-4 px-4 py-10 no_scrollbar">
            ...
            <div className="flex-shrink-0 w-64 md:w-96 rounded-xl overflow-hidden shadow-lg bg-neutral-200">
              ...
              <div className="px-6 pt-8 pb-8">
                ...
                <p className="text-gray-700 text-base text-justify">
                  A personal project website made for my cat. It showcases my
                  cat Nini. The site aims to capture the joy she brings to my
                  life and share it with fellow cat lovers.
                </p>
              </div>
            </div>
            <div className="flex-shrink-0 w-64 md:w-96 rounded-xl overflow-hidden shadow-lg bg-neutral-200">
              ...
              <div className="px-6 pt-8 md:pb-20">
                ...
                <p className="text-gray-700 text-base">
                  A capstone project that aims to create a booking website for
                  van rental cooperative and manage their system for a more
                  efficient work flow.
                </p>
              </div>
            </div>
            <div className="flex-shrink-0 w-64 md:w-96 rounded-xl overflow-hidden shadow-lg bg-neutral-200">
              ...
              <div className="px-6 pt-8 pb-8">
                ...
                <p className="text-gray-700 text-base">
                  A website for a pizza business. Equipped with the business'
                  menu and branch locator.
                </p>
              </div>
            </div>
            <div className="flex-shrink-0 w-64 md:w-96 rounded-xl overflow-hidden shadow-lg bg-neutral-200">
              ...
              <div className="px-6 pt-8 pb-8">
                ...
                <p className="text-gray-700 text-base">
                  ...
                  Javascript. This website showcases my skills and projects in
                  web development.
                </p>
              </div>
            </div>
        ...
        <div className="hidden md:block bottom-0 transform absolute w-full bg-neutral-900 text-neutral-900">
          <h1>.</h1>
        </div>
